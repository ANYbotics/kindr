...
\draw[black, ,->] (0,0,0) -- (1,0,0) node[anchor=north east]{$e_x^{D}$};
\draw[black, ,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$e_y^{D}$};
\draw[black, ,->] (0,0,0) -- (0,0,1) node[anchor=west]{$e_z^{D}$,
    \textcolor{red}{$e_{z'}^C$}}; 

% Intermediate frame 1
\tdplotsetrotatedcoords{\zRot}{0}{0}
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (1,0,0) node[anchor=west]{$e_{x'}^C$};
...
\draw[black, ,->] (0,0,0) -- (1,0,0) node[anchor=north east]{$e_x^{D}$};
\draw[black, ,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$e_y^{D}$};
\draw[black, ,->] (0,0,0) -- (0,0,1) node[anchor=west]{$e_z^{D}$    \textcolor{red}{$e_{z'}^C$}}; 
...
node[anchor=west]{$e_{y''}^B$, \textcolor{red}{$e_{y'}^C$}};
...
\vC_{A\!D} &= {\color{blue}\vC_{A\!B}} {\color{green!50!black}\vC_{B\!C}} {\color{red}\vC_{C\!D}} \quad \Rightarrow \quad _{A}\vr = \vC_{A\!D} {}_{D}\vr  \\
   ...
   \cos{\phi} \sin{\psi} + \cos{\psi} \sin{\phi} \sin{\theta} & \cos{\phi} \cos{\psi} - \sin{\phi} \sin{\theta} \sin{\psi} & -\cos{\theta} \sin{\phi} \\
   \sin{\phi} \sin{\psi} - \cos{\phi} \cos{\psi} \sin{\theta} & \cos{\psi} \sin{\phi} + \cos{\phi} \sin{\theta} \sin{\psi} &  \cos{\phi} \cos{\theta} \\
\end{pmatrix} 
\end{aligned}$};
% Set origin of main (body) coordinate system
\coordinate (O) at (0,0,0);
...
node[anchor=west]{$e_{x'''}^D$, \textcolor{green!50!black}{$e_{x''}^B$}};
\draw[tdplot_rotated_coords,->, blue] (0,0,0) -- (0,1,0) node[anchor=west]{$e_{y'''}^A$};
\draw[tdplot_rotated_coords,->, blue] (0,0,0) -- (0,0,1) node[anchor=north east]{$e_{z'''}^A$};
