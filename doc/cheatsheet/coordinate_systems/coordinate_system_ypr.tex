...
\draw[black, ,->] (0,0,0) -- (1,0,0) node[anchor=north east]{$e_x^{I}$};
\draw[black, ,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$e_y^{I}$};
\draw[black, ,->] (0,0,0) -- (0,0,1) node[anchor=west]{$e_z^{I}$,
    \textcolor{red}{$e_{z'}^H$}}; 

% Intermediate frame 1
\tdplotsetrotatedcoords{\zRot}{0}{0}
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (1,0,0) node[anchor=west]{$e_{x'}^H$};
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (0,1,0) node[anchor=west]{$e_{y'}^H$};
\draw[thick,tdplot_rotated_coords,->, red] (0,0,0) -- (0,0,1) node[anchor=west]{};

\tdplotsetrotatedthetaplanecoords{0}
\tdplotdrawarc[dashed,->,color=black]{(0,0,0)}{.5}{0}{\zRot}{anchor=north east,color=black}{$\psi$}
...
\draw[black, ,->] (0,0,0) -- (1,0,0) node[anchor=north east]{$e_x^{I}$};
\draw[black, ,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$e_y^{I}$};
\draw[black, ,->] (0,0,0) -- (0,0,1) node[anchor=west]{$e_z^{I}$    \textcolor{red}{$e_{z'}^A$}}; 

% Intermediate frame 1
\tdplotsetrotatedcoords{\zRot}{0}{0}
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (1,0,0) node[anchor=west]{$e_{x'}^A$};
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (0,1,0) node[anchor=west]{};
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (0,0,1) node[anchor=west]{};

\tdplotsetrotatedthetaplanecoords{0}
\tdplotdrawarc[dashed,tdplot_rotated_coords,->,color=red]{(0,0,0)}{0.5}{0}{\yRot}{anchor=south,color=red}{$\theta$}
...
node[anchor=west]{$e_{y''}^C$, \textcolor{red}{$e_{y'}^H$}};
...
%%%%%%%%%%%%% Z-Y-X
\begin{tikzpicture}[scale=1.5,tdplot_main_coords,baseline=(current bounding box.north)]
\node(rectangle) at (0,5.5,2.2){$\tiny\begin{aligned}
\vR_{BI} &= {\color{blue}\vR_{BC}} {\color{green!50!black}\vR_{CH}} {\color{red}\vR_{HI}} \\
...
\draw[black, ,->] (0,0,0) -- (1,0,0) node[anchor=north east]{$e_x^{I}$};
\draw[black, ,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$e_y^{I}$};
\draw[black, ,->] (0,0,0) -- (0,0,1) node[anchor=west]{$e_z^{I}$   \textcolor{red}{$e_{z'}^H$}}; 
...
node[anchor=west]{$e_{x'''}^B$, \textcolor{green!50!black}{$e_{x''}^C$}};
\draw[tdplot_rotated_coords,->, blue] (0,0,0) -- (0,1,0) node[anchor=west]{$e_{y'''}^B$};
\draw[tdplot_rotated_coords,->, blue] (0,0,0) -- (0,0,1) node[anchor=north east]{$e_{z'''}^B$};
...
\tdplotdrawarc[dashed,tdplot_rotated_coords,->,color=green!50!black]{(0,0,0)}{0.5}{90}{90+\xRot}{anchor= west,color=green!50!black}{$\phi$}
