...
\pgfmathsetmacro{\rcaeul}{\sasb - \casbcg}
...
\draw[tdplot_rotated_coords,->, red] (0,0,0) -- (1,0,0) node[anchor=west]{$e_{x'}^D$};
...
\draw[black, ,->] (0,0,0) -- (1,0,0) node[anchor=north east]{$e_x^{I}$};
\draw[black, ,->] (0,0,0) -- (0,1,0) node[anchor=north west]{$e_y^{I}$};
\draw[black, ,->] (0,0,0) -- (0,0,1) node[anchor=west]{$e_z^{I}$    \textcolor{red}{$e_{z'}^D$}}; 
...
node[anchor=west]{$e_{y''}^C$, \textcolor{red}{$e_{y'}^D$}};
