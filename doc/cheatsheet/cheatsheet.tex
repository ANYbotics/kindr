...
\myfigure{\includegraphics[width=1\columnwidth]{coordinate_systems/coordinate_system_ypr-crop.pdf}%
\figcaption{Rotation from $I$-frame to $C$-frame: (yaw-pitch-roll) -- ($\psi-\theta-\phi$) -- ($z-y'-x''$)}}
% \begin{figure}
