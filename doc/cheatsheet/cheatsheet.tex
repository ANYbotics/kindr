...
\subsection{Quaternion $\Leftrightarrow$ Rotation Matrix}

\subsection{Kardan angles: Roll-Pitch-Yaw}
\begin{equation}
\begin{split}
\vR_{BI} &= \begin{pmatrix} 2(e_0^2+e_1^2)-1 & 2(e_1 e_2+e_0 e_3) & 2(e_1 e_3-e_0 e_2) \\ 2(e_1 e_2-e_0 e_3) & 2(e_0^2+e_2^2)-1 & 2(e_2 e_3+e_0 e_1) \\ 2(e_1 e_3+e_0 e_2) & 2(e_2 e_3-e_0 e_1) & 2(e_0^2+e_3^2)-1 \end{pmatrix}
\end{split}
\end{equation}
