...
${}_B\vr_{OP} = \vp_{IB} (0, {}_I\vr_{OP}^T)^T \vp_{BI}^{-1} = {}_I\vr_{OP} + 2a_0\tilde{\va} {}_I\vr_{OP} + 2 \tilde{\va}^2 {}_I\vr_{OP},  \quad \vp_{BI}=(a_0, \va^T)^T$ ????
...
a_1 &  a_0 &  a_3 & -a_2 \\
a_2 & -a_3 &  a_0 &  a_1 \\
a_3 &  a_2 & -a_1 &  a_0 \\ \end{bmatrix}\begin{bmatrix} b_0 \\ b_1 \\ b_2 \\ b_3 \end{bmatrix}  \end{aligned}$
...
$\vA_{IB} = \vR_{BI} =  \vI_{3x3} + 2 a_0\tilde{\va} + 2 \tilde{\va}^2  = \begin{pmatrix} 1 - 2 a_2^2 - 2 a_3^2  &     2 a_1 a_2 - 2 a_0 a_3 &     2 a_0 a_2 + 2 a_1 a_3 \\
