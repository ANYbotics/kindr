...
int main(int argc, char **argv){
  ...
  std::cout << "Rotated vector: " << EulerAnglesRPYD(M_PI/2.0, M_PI/2.0, M_PI/2.0).rotate(I_r_0F).transpose() << std::endl;
